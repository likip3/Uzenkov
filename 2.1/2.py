...
class DataSet:
    ...
    def getDynamics(self):
        ...
        dynamicsSalByCityDescOrder = list(filter(lambda x: x[0] in list(numVacByYearForVac.keys()), [(k, v) for k, v in dynamicsSalByCityDescOrder.items()]))
    ...
    @staticmethod
    def print_statistic(salByYear, numByYear, salByYearForVac, numVacByYearForVac, dynamicsSalByCityDescOrder, dynamicsRateByCity):
        listDynamics = [salByYear, numByYear, salByYearForVac, numVacByYearForVac, dynamicsSalByCityDescOrder, dynamicsRateByCity]
